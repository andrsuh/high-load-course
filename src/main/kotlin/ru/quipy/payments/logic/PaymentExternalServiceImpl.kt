...
class PaymentExternalSystemAdapterImpl(
    ...
    /*val payOrderBucket = Bucket.builder()
        .addLimit(Function { limit: BandwidthBuilderCapacityStage? ->
            limit!!
                .capacity(40)
                .refillIntervally(11, Duration.ofSeconds(1))
        })
        .build();*/
    val tokenBucket = TokenBucketRateLimiter(
        rate = properties.rateLimitPerSec,
        bucketMaxCapacity = properties.rateLimitPerSec + 5,
        window = 1,
        timeUnit = TimeUnit.SECONDS
    )

        @RateLimiter(name = "payOrderExternal")
